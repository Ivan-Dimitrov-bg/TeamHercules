...
var level1 = {
	...
	[7, 33, 'h', 'while(!caught){eat}'],
	[128, 43, 'v', 'getDay()'],
	[150, 83, 'h', 'console.log'],
	[60, 133, 'h', 'this'],
	[153, 133, 'h', 'querySelector'],
	[7, 183, 'h', 'document.getElementById(\'u\')'],
	[128, 185, 'v', 'level = 0'],
	[7, 233, 'h', 'x = 100'],
	[155, 233, 'h', 'y = x*2'],
	[23, 243, 'v', 'var hi = bye'],
	...
	[53, 333, 'h', 'ctx.fill();'],
	[225, 243, 'v', 'else if ()'],
	[32, 385, 'h', 'parentDiv.tagName'],
	[327, 45, 'v', 'mouseover'],
	[277, 213, 'v', 'for (g in game)'],
	...
	[427, 50, 'v', 'that'],
	[427, 300, 'v', 'self'],
	[450, 83, 'h', 'addEventListener'],
	[630, 85, 'v', '//this is a comment'],
	[385, 133, 'h', 'var pac = yellow'],	
	[385, 283, 'h', 'setInterval(f,10)'],
	[577, 137, 'v', 'prompt(oh)'],
	[702, 133, 'h', 'if (!beer) {thirsty}'],
	[707, 33, 'h', 'direction = \'right\''],
